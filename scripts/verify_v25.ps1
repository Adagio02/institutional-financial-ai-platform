...
try {
    ...
    Write-Host "Version 2.5 verification" -ForegroundColor Cyan
    Write-Host "========================================" -ForegroundColor Cyan
    ...
    Write-Host ""
    Write-Host "Checking current migration..." -ForegroundColor Cyan
    ...
    Write-Host ""
    Write-Host "Verifying Alpaca trade stream..." -ForegroundColor Cyan

    python .\scripts\verify_alpaca_v21.py

    if ($LASTEXITCODE -ne 0) {
        throw "V2.1 Alpaca stream verification failed."
    }
    ...
    if ($LASTEXITCODE -ne 0) {
        throw "V2.2 reconciliation verification failed."
    }

    Write-Host ""
    Write-Host "Verifying broker discovery..." -ForegroundColor Cyan

    python .\scripts\verify_alpaca_discovery_v23.py

    if ($LASTEXITCODE -ne 0) {
        throw "V2.3 broker discovery verification failed."
    }

    Write-Host ""
    Write-Host "Verifying orphan recovery..." -ForegroundColor Cyan

    python .\scripts\verify_alpaca_orphan_recovery_v24.py

    if ($LASTEXITCODE -ne 0) {
        throw "V2.4 orphan recovery verification failed."
    }

    Write-Host ""
    Write-Host "Verifying Alpaca account guard..." -ForegroundColor Cyan

    python .\scripts\verify_alpaca_account_guard_v25.py

    if ($LASTEXITCODE -ne 0) {
        throw "V2.5 account guard verification failed."
    }

    Write-Host ""
    Write-Host "========================================" -ForegroundColor Green
    Write-Host "Version 2.5 verification passed." -ForegroundColor Green
    Write-Host "========================================" -ForegroundColor Green
    Write-Host ""
}
catch {
    ...
    Write-Host "Version 2.5 verification failed." -ForegroundColor Red
    Write-Host "========================================" -ForegroundColor Red
    Write-Host ""
