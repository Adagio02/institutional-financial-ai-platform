...
try {
    ...
    Write-Host "Version 2.6 verification" -ForegroundColor Cyan
    Write-Host "========================================" -ForegroundColor Cyan
    ...
    Write-Host ""
    Write-Host "Verifying V2.1 trade stream..." -ForegroundColor Cyan
    ...
    Write-Host ""
    Write-Host "Verifying V2.2 reconciliation..." -ForegroundColor Cyan
    ...
    Write-Host ""
    Write-Host "Verifying V2.3 discovery..." -ForegroundColor Cyan
    ...
    Write-Host ""
    Write-Host "Verifying V2.4 orphan recovery..." -ForegroundColor Cyan
    ...
    Write-Host ""
    Write-Host "Verifying V2.5 account guard..." -ForegroundColor Cyan
    ...
    Write-Host ""
    Write-Host "Verifying V2.6 market guard..." -ForegroundColor Cyan
    ...
    Write-Host "Version 2.6 verification passed." -ForegroundColor Green
    Write-Host "========================================" -ForegroundColor Green
}
catch {
    Write-Host ""
    Write-Host "========================================" -ForegroundColor Red
    Write-Host "Version 2.6 verification failed." -ForegroundColor Red
    Write-Host "========================================" -ForegroundColor Red
    Write-Host ""
