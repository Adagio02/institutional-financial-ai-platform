...
def upgrade() -> None:
    ...
    op.create_index(
        op.f(
            "ix_strategy_policies_account_id"
        ),
        "strategy_policies",
        [
            "account_id",
    ...
    op.create_index(
        op.f(
            "ix_strategy_policies_strategy_key"
        ),
        "strategy_policies",
        [
            "strategy_key",
    ...
    op.create_index(
        op.f(
            "ix_strategy_positions_account_id"
        ),
        "strategy_positions",
        [
            "account_id",
    ...
    op.create_index(
        op.f(
            "ix_strategy_positions_strategy_key"
        ),
        "strategy_positions",
        [
            "strategy_key",
    ...
    op.create_index(
        op.f(
            "ix_strategy_positions_instrument_id"
        ),
        "strategy_positions",
        [
            "instrument_id",
