...
from finai.application.services.v472_learning_service import (
    V472LearningService,
)
from finai.core.config import Settings


def build_v472_learning_service(
    *,
    settings: Settings,
) -> V472LearningService:
    return V472LearningService(
        ...
        long_probability_thresholds=parse_thresholds(
            settings.v41_long_probability_thresholds
        ),
        short_probability_thresholds=parse_thresholds(
            settings.v41_short_probability_thresholds
        ),
