...
class ProposalExecutionService:
    def __init__(
        ...
        *,
        ...
        self._proposal_maximum_age_seconds = (
            proposal_maximum_age_seconds
        )

        self._maximum_price_drift_bps = (
            maximum_price_drift_bps
        )

        self._manual_approval_required = (
    ...
    def execute(
        ...
        *,
        ...
        if (
            ...
            reason = (
                "Market price drift exceeds "
                "the proposal execution limit."
            )
